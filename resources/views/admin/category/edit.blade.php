    ...
    <div class="page-content--bgf7 mb-5">
        ...
        <div class="container-fluid">
            <div class="card mx-5">
                ...
                <form action="{{route('admin.category.update',['id'=>$data->id])}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" value="{{$data->description}}" id="text-input" name="description" class="form-control">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="file" value="{{$data->image}}" id="file-input" name="image" class="form-control-file">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
