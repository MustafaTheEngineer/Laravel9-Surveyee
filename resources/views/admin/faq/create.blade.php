...
@section('content')
    ...
    <div class="page-content--bgf7 mb-5">
        ...
        <div class="container my-3">
            <div class="card mx-5">
                <form action="{{route('admin.faq.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                <div class="card-body card-block">
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="question" placeholder="Question" class="form-control font-weight-bold">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                            ...
                            <div class="col-12 col-md-9">
                                <textarea name="answer" id="answer" class="border p-2">
                                </textarea>
                            </div>
                        </div>
                        <div class="row form-group">
